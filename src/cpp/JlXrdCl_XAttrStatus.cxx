...
struct JlXrdCl_XAttrStatus: public Wrapper {
  ...
  JlXrdCl_XAttrStatus(jlcxx::Module& jlModule): Wrapper(jlModule){
    ...
    // defined in /Users/mato/.julia/artifacts/d7f8626a7055397045bff10d1f18132236662705/include/xrootd/XrdCl/XrdClXRootDResponses.hh:294:10
  ...
  void add_methods() const{
    ...
    // defined in /Users/mato/.julia/artifacts/d7f8626a7055397045bff10d1f18132236662705/include/xrootd/XrdCl/XrdClXRootDResponses.hh:299:7
    ...
    // defined in /Users/mato/.julia/artifacts/d7f8626a7055397045bff10d1f18132236662705/include/xrootd/XrdCl/XrdClXRootDResponses.hh:305:19
    // signature to use in the veto list: XrdCl::XAttrStatus::name
    t.method("name", [](const XrdCl::XAttrStatus& a) -> const std::string& { return a.name; }, jlcxx::arg("this"));
    t.method("name", [](XrdCl::XAttrStatus& a) -> std::string& { return a.name; }, jlcxx::arg("this"));
    t.method("name", [](const XrdCl::XAttrStatus* a) -> const std::string& { return a->name; }, jlcxx::arg("this"));
    t.method("name", [](XrdCl::XAttrStatus* a) -> std::string& { return a->name; }, jlcxx::arg("this"));
    // defined in /Users/mato/.julia/artifacts/d7f8626a7055397045bff10d1f18132236662705/include/xrootd/XrdCl/XrdClXRootDResponses.hh:305:19
    // signature to use in the veto list: XrdCl::XAttrStatus::name
    ...
    t.method("name!", [](XrdCl::XAttrStatus& a, const std::string& val) -> std::string& { return a.name = val; }, jlcxx::arg("this"), jlcxx::arg("value"));

    DEBUG_MSG("Adding name! methods to provide write access to the field name (" __HERE__ ")");
    t.method("name!", [](XrdCl::XAttrStatus* a, const std::string& val) -> std::string& { return a->name = val; }, jlcxx::arg("this"), jlcxx::arg("value"));

    DEBUG_MSG("Adding status methods  to provide read access to the field status (" __HERE__ ")");
    // defined in /Users/mato/.julia/artifacts/d7f8626a7055397045bff10d1f18132236662705/include/xrootd/XrdCl/XrdClXRootDResponses.hh:306:20
    // signature to use in the veto list: XrdCl::XAttrStatus::status
    t.method("status", [](const XrdCl::XAttrStatus& a) -> const XrdCl::XRootDStatus& { return a.status; }, jlcxx::arg("this"));
    t.method("status", [](XrdCl::XAttrStatus& a) -> XrdCl::XRootDStatus& { return a.status; }, jlcxx::arg("this"));
    t.method("status", [](const XrdCl::XAttrStatus* a) -> const XrdCl::XRootDStatus& { return a->status; }, jlcxx::arg("this"));
    t.method("status", [](XrdCl::XAttrStatus* a) -> XrdCl::XRootDStatus& { return a->status; }, jlcxx::arg("this"));
    // defined in /Users/mato/.julia/artifacts/d7f8626a7055397045bff10d1f18132236662705/include/xrootd/XrdCl/XrdClXRootDResponses.hh:306:20
    // signature to use in the veto list: XrdCl::XAttrStatus::status
    ...
    t.method("status!", [](XrdCl::XAttrStatus& a, const XrdCl::XRootDStatus& val) -> XrdCl::XRootDStatus& { return a.status = val; }, jlcxx::arg("this"), jlcxx::arg("value"));
